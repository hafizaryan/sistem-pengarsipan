    ...
    if ($_SESSION['admin'] != 1 and $_SESSION['admin'] != 2) {
        ...
        if (isset($_REQUEST['sub'])) {
            ...
            if (isset($_REQUEST['submit'])) {
                ...
                if (
                    $_REQUEST['institusi'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['ketua'] == "" || $_REQUEST['nip'] == ""
                    || $_REQUEST['website'] == ""
                ) {
                            ...
                            if (!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat)) {
                                ...
                                if (!preg_match("/^[a-zA-Z., ]*$/", $ketua)) {
                                    ...
                                    if (!preg_match("/^[0-9 -]*$/", $nip)) {
                                        $_SESSION['nipketua'] = 'Form NIP ketua hanya boleh mengandung karakter angka, spasi, dan minus(-)<br/><br/>';
                                        echo '<script language="javascript">window.history.back();</script>';
                                    } else {
                                            ...
                                            if (!empty($logo)) {
                                                ...
                                                if (in_array($eks, $ekstensi) == true) {
                                                    if ($ukuran < 2000000) {
                                                        ...
                                                        $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',alamat='$alamat',ketua='$ketua',nip='$nip',website='$website',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                                        if ($query == true) {
                                                ...
                                                $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',alamat='$alamat',ketua='$ketua',nip='$nip',website='$website',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                                if ($query == true) {
                                                    $_SESSION['succEdit'] = 'SUKSES! Data instansi berhasil diupdate';
                                                    header("Location: ././admin.php?page=sett");
                                                    die();
                            ...
                            <form class="col s12" method="post" action="?page=sett" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <?php
                                        if (isset($_SESSION['nipketua'])) {
                                            $nipketua = $_SESSION['nipketua'];
                                            echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">' . $nipketua . '</div>';
                                            unset($_SESSION['nipketua']);
                                        }
                                        ?>
