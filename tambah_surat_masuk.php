                                            ...
                                            $cek = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE no_surat='$no_surat'");
                                                ...
                                                if($result > 0){
                                                    ...
                                                    if($file != ""){
                                                            ...
                                                            if($ukuran < 2500000){
                                                                ...
                                                                $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,isi,kode,tgl_surat,
                                                                    tgl_diterima,file,id_user)
                                                                        VALUES('$no_agenda','$no_surat','$asal_surat','$isi','$nkode','$tgl_surat',NOW(),'$nfile','$id_user')");
                                                        ...
                                                        $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,isi,kode,tgl_surat, tgl_diterima,file,id_user)
                                                            VALUES('$no_agenda','$no_surat','$asal_surat','$isi','$nkode','$tgl_surat',NOW(),'','$id_user')");
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="tgl_surat" type="text" name="tgl_surat" class="datepicker" required>
                                ...
                                ?>
                            <label for="tgl_surat">Tanggal Surat Masuk</label>
                        </div>
                        <div class="input-field col s6">
