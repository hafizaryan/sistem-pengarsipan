            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                ...
                echo '
                    ...
                    <div class="row agenda">
                        ...
                        <div class="col s12" style="display: flex; justify-content: flex-end; margin-left: -2px;">
                            <button type="submit" onClick="window.print()" class="btn-large deep-orange waves-effect waves-light">CETAK <i class="material-icons">print</i></button>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        if($row['id_user'] == 1){
                                            ...
                                            if ($query3) {
                                                ...
                                                $row['id_user'] = 'Pengguna tidak ditemukan';
                                            }
                                        }
                                        ...
                                        // Check if 'keterangan' index exists in $row array
