                                        ...
                                        // } else {
                                            ...
                                            if($result > 0){
                                                ...
                                                if($file != ""){
                                                    ...
                                                    if(in_array($eks, $ekstensi) == true){
                                                        if($ukuran < 2500000){
                                                            ...
                                                            $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,tujuan,no_surat,isi,kode,tgl_surat,
                                                                ...
                                                                VALUES('$no_agenda','$tujuan','$no_surat','$isi','$nkode','$tgl_surat',NOW(),'$nfile','$id_user')");
                                                    ...
                                                    $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,tujuan,no_surat,isi,kode,tgl_surat,
                                                        tgl_catat,file,id_user)
                                                        VALUES('$no_agenda','$tujuan','$no_surat','$isi','$nkode','$tgl_surat',NOW(),'','$id_user')");
