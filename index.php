        ...
        <div class="row">
            ...
            <div class="col s12 m6 offset-m3 offset-m3">
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <?php
                    // Data logo
                    $data['logo'] = 'KI_LOGO.png';
                    // Data nama
                    $data['nama'] = 'Komisi Informasi';
                    ?>

                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title">Archive KI</h5>
                            <img id="logo" src="upload/<?php echo $data['logo']; ?>" alt="Logo">
                    ...
                    <style>
                        #title {
                            font-family: 'cambria', sans-serif; /* Replace with the actual font name */
